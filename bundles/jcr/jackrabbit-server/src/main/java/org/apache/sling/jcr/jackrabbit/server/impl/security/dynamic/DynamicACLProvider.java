 ...
 */
public class DynamicACLProvider extends AbstractAccessControlProvider implements AccessControlConstants {
     ...
     */
    private DynamicACLEditor systemEditor;
    ...
    public void init(Session systemSession, Map configuration) throws RepositoryException {
        ...
        systemEditor = new DynamicACLEditor(systemSession, this);
    ...
    public AccessControlEditor getEditor(Session session) {
        checkInitialized();
        return new DynamicACLEditor(session, this);
    }
    ...
    private static void initRootACL(SessionImpl session, AccessControlEditor editor) throws RepositoryException {
        try {
            ...
            DynamicACLTemplate acl = (DynamicACLTemplate) acls[0];
    ...
    private class Entries {
        ...
        private AccessControlEntryIterator iterator() {
            ...
            for (Iterator<?> it =
                    ((ListOrderedMap)principalNamesToEntries).asList().iterator(); it.hasNext();) {
                Object key = it.next();
